  ...
  cat > "${CLINICS_FILE}" <<'JSON'
{
  "clinics": [
    {
      "key": "generica1",
      "nombre": "Clínica Genérica 1",
      "mspId": "ClinicaGenerica1MSP",
      "domain": "generica1.example.com",
      "peerPort": 7051,
      "chaincodePort": 7052,
      "operationsPort": 9444,
      "privateChannel": "canal-generica-1",
      "profile": "CanalGenerica1",
      "configtxDir": "",
      "composeFile": "",
      "estado": "activa",
      "fundadora": true
    ...
    {
      "key": "generica2",
      "nombre": "Clínica Genérica 2",
      "mspId": "ClinicaGenerica2MSP",
      "domain": "generica2.example.com",
      "peerPort": 9051,
      "chaincodePort": 9052,
      "operationsPort": 9445,
      "privateChannel": "canal-generica-2",
      "profile": "CanalGenerica2",
      "configtxDir": "",
      "composeFile": "",
      "estado": "activa",
      "fundadora": true
